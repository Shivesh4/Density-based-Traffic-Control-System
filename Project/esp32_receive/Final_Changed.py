...
def sort_road_values():
    ...
    road1 = max(min(road1, 22), 4)
    road2 += trend_direction2
    road2 = max(min(road2, 14), 4)
    road3 += trend_direction3
    road3 = max(min(road3, 22), 4)
    road4 += trend_direction4
    road4 = max(min(road4, 14), 4)
...
def set_time_variables():
    ...
    start_timestamp = datetime.datetime(2023, 5, 22, 13, 0, 0)
    end_timestamp = datetime.datetime(2023, 5, 22, 13, 5, 0)
